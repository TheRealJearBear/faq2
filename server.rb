...
def selected_launcher(id, launchers)
  selected_launcher = launchers.find { |launcher| launcher["id"] == id }
end
...
get '/api/v1/launchers/:id' do
  selected_launcher_id = params[:id].to_i
  json selected_launcher(selected_launcher_id, read_launchers)
end
